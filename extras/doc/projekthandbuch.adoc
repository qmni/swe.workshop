...
.Use Cases
[plantuml,use-cases-player,svg]
----
include::use-cases-player.plantuml[]
----
...
.Komponentendiagramm
[plantuml,komponenten-player,svg]
----
include::komponenten-player.plantuml[]
----
...
[plantuml,player-router,svg]
----
include::player-router.plantuml[]
----
...
[plantuml,sequenzdiagramm-player,svg]
----
include::sequenzdiagramm-player.plantuml[]
----
...
[plantuml,player-write-router,svg]
----
include::player-write-router.plantuml[]
----
...
."PlayerService" von der Geschäftslogik
[plantuml,PlayerService,svg]
----
include::PlayerService.plantuml[]
----

Pellentesque in ipsum id orci porta dapibus. Donec rutrum congue leo eget
malesuada.

."PlayerWriteService" von der Geschäftslogik
[plantuml,PlayerWriteService,svg]
----
include::PlayerWriteService.plantuml[]
----
...
.ER-Diagramm
[plantuml,ER-Diagramm-Player,svg]
----
include::ER-Diagramm-Player.plantuml[]
----
